...
export function ContactPageClient() {
    ...
    const inputBase =
        "w-full rounded-xl border bg-background/50 px-4 py-3 text-sm text-foreground placeholder:text-muted-foreground/50 focus:outline-none focus:ring-2 focus:ring-blue-500/30 focus:border-blue-500/50 transition-all";
    const okBorder = "border-border/50";
            ...
            <div className="mb-6">
                ...
                >
                    <SelectTrigger
                        ...
                        className={cn(
                            "w-full h-12 rounded-xl border bg-background/50 px-4 text-sm text-foreground transition-all data-placeholder:text-muted-foreground/60 focus-visible:ring-2 focus-visible:ring-blue-500/30 focus-visible:border-blue-500/50",
            ...
            <div className="mb-8">
                ...
                <div className="flex items-center gap-3 flex-wrap">
                    <button
                        ...
                        disabled={isSending}
                        className="inline-flex items-center gap-2 h-10 px-4 rounded-xl border border-border/50 bg-background/50 text-sm text-foreground hover:bg-blue-500/10 hover:border-blue-500/40 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
