...
export function ExtensionsAuthorsHome() {
    ...
    <div className="w-full space-y-10">
      <header className="space-y-2">
        ...
        <p className="max-w-xl text-[15px] leading-relaxed text-muted-foreground">
          Pick an author to see who launched their CEP extension, installed packs,
          errors, and revoke devices.
        </p>
      </header>
