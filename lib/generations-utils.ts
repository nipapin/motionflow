...
export const IMAGE_STYLE_PRESETS = [
  ...
  { id: "vector_illustration", label: "SVG · Illustration" },
  { id: "vector_illustration/cartoon", label: "SVG · Cartoon" },
  { id: "vector_illustration/doodle_line_art", label: "SVG · Doodle line art" },
  { id: "vector_illustration/engraving", label: "SVG · Engraving" },
  { id: "vector_illustration/flat_2", label: "SVG · Flat 2" },
  { id: "vector_illustration/kawaii", label: "SVG · Kawaii" },
  { id: "vector_illustration/line_art", label: "SVG · Line art" },
  { id: "vector_illustration/line_circuit", label: "SVG · Line circuit" },
  { id: "vector_illustration/linocut", label: "SVG · Linocut" },
  { id: "vector_illustration/seamless", label: "SVG · Seamless pattern" },
  { id: "icon", label: "SVG · Icon" },
  { id: "icon/broken_line", label: "SVG · Icon broken line" },
  { id: "icon/colored_outline", label: "SVG · Icon colored outline" },
  { id: "icon/colored_shapes", label: "SVG · Icon colored shapes" },
  { id: "icon/colored_shapes_gradient", label: "SVG · Icon colored gradient" },
  { id: "icon/doodle_fill", label: "SVG · Icon doodle fill" },
  { id: "icon/doodle_offset_fill", label: "SVG · Icon doodle offset" },
  { id: "icon/offset_fill", label: "SVG · Icon offset fill" },
  { id: "icon/outline", label: "SVG · Icon outline" },
  { id: "icon/outline_gradient", label: "SVG · Icon outline gradient" },
  { id: "icon/uneven_fill", label: "SVG · Icon uneven fill" },
] as const;
