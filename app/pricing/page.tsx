        ...
        <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
          ...
          <div className="relative rounded-3xl border border-blue-500/20 bg-card/80 backdrop-blur-sm p-8 hover:border-blue-500/40 transition-all duration-300">
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Full access to the template and audio library
              </p>
            </div>
              ...
              {billingPeriod === "yearly" && (
                <div className="flex items-center gap-2 mt-2">
                  ...
                  <span className="text-foreground text-sm font-medium">
                    ${yearlyPrice.toFixed(0)}/year
                  </span>
                </div>
              )}
            </div>

            <Button className="w-full mb-8 h-12 rounded-xl border border-blue-500/30 bg-blue-500/10 text-foreground hover:bg-blue-500/20 transition-all duration-300">
              Get Started
            </Button>
          ...
          <div className="relative rounded-3xl border-2 border-blue-500/50 bg-gradient-to-br from-card via-card to-blue-500/5 backdrop-blur-sm p-8 shadow-xl shadow-blue-500/10">
            ...
            <div className="mb-6">
              ...
              <p className="text-muted-foreground text-sm leading-relaxed">
                Full library access plus all AI tools
              </p>
            </div>
            ...
            <div className="mb-6">
              ...
              {billingPeriod === "yearly" && (
                <div className="flex items-center gap-2 mt-2">
                  <span className="text-muted-foreground line-through text-sm">
                    ${ultimateMonthly * 12}/year
                  </span>
                  <span className="text-foreground text-sm font-medium">
                    ${ultimateYearly.toFixed(0)}/year
                  </span>
                </div>
              )}
            </div>

            <Button className="w-full mb-8 h-12 rounded-xl bg-gradient-to-r from-blue-600 to-blue-500 text-white hover:from-blue-500 hover:to-blue-400 shadow-lg shadow-blue-500/25 transition-all duration-300">
              Get Started
            </Button>
