    ...
    return (
      <div className="space-y-6">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">Marketplace orders and AI credit packs</p>
        </div>
        <ProfileEmptyState
          icon={ShoppingBag}
          title="No purchases yet"
          description="Marketplace orders and extra AI generation packs appear here after checkout."
        >
